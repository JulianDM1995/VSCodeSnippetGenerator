...
export const Output = ({ index }: { index: number }) => {
  ...
  const handleOutputChange = (value: string) => {
    updatePlaceholder(index, { output: value || undefined })
  }
...
const defaultFieldPlaceholders: FieldPlaceholder[] = [
  {
    value: 'LABEL',
